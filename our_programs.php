...
<head>
  ...
  <link rel="stylesheet" href="our_programs.css">
</head>
<header>
    <div class="navbar">
...
<img src="images/math2.jpg" alt="Mathematics Banner">
 ...
 <div class="math-section">
  ...
  <div class="topics-grid">
      <!-- Topic 1 -->
      <div class="topic-card addition">
          <h3><b>Addition & Subtraction</b></h3>
          <p>Master the basics of adding and subtracting numbers with confidence.</p>
      </div>
      <!-- Topic 2 -->
      <div class="topic-card multiplication">
          <h3><b>Multiplication & Division</b></h3>
          <p>Learn how to multiply and divide efficiently to solve everyday problems.</p>
      </div>
      <!-- Topic 3 -->
      <div class="topic-card fractions">
          <h3><b>Fractions</b></h3>
